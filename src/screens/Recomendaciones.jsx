const FALLBACK = [
  { icon: '☀️', nombre: 'Vitamina D3', razon: 'Por déficit detectado', dosis: '1000 UI / día', precio: 16 },
  { icon: '⚡', nombre: 'Zinc',        razon: 'Refuerza inmunidad',     dosis: '15 mg / día',   precio: 12 },
  { icon: '🍊', nombre: 'Vitamina C',  razon: 'Potencia el zinc',       dosis: '500 mg / día',  precio: 8  },
]
    ...
    <div className="screen" style={{ background: 'var(--gray-50)', gap: 0 }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--green-dark)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 }}>
          Pack ideal · {recs.length} producto{recs.length !== 1 ? 's' : ''}
        </div>
